...
| `skills/plumbline-adopt/**` | The license of each canonical source file, as listed in the bundle's own map | per canonical file |
...
Files copied into `skills/plumbline-adopt/` do not acquire an umbrella license.
